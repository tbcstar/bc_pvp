...
class Migration_Add_permissions extends CI_Migration
{
    public function up()
    {
        $this->permission_model->insert_batch([
            ['key' => 'view.pvp', 'module' => 'pvp', 'description' => 'Can view pvp page']
        ]);

        $permissions = $this->permission_model->find_all(['module' => 'pvp']);
        $permsLinked = [];
    ...
    {
        $permissions    = $this->permission_model->find_all(['module' => 'pvp'], 'array');
